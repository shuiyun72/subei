<template>
	<view class="login buy_goods_join">
		<view class="mine_l">
			<image src="../../static/img/toux.png" class="mine_logo" mode="widthFix"></image>
		</view>
		<view class="yaoqing blue">
			杨晓晓邀请您购买商品
		</view>
		...
		<view class="icon_input_sy">
			<view class="iconfont iconxinhan"></view>
			<input class="input" type="text" v-model="yqm" placeholder="请输入邀请码" />
		</view>
		<view class="sub_top">
...
<script>
	export default {
		...
		methods: {
			loginIn() {
				uni.navigateTo({
					url:'../goodsDetail/goodsDetail?showShareIcon=false'
				})
			}
